...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 h-full w-64 bg-white border-r transition-transform duration-200 transform ${
                      ...
                      <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-4">
                          <div className={`p-2 rounded-lg ${
                            activity.type === 'application' ? 'bg-blue-100 text-blue-500' :
                            activity.type === 'job' ? 'bg-green-100 text-green-500' :
      ...
      <AnimatePresence>
        {notificationsOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-16 right-24 w-80 bg-white rounded-xl shadow-lg border"
          >
      ...
      <AnimatePresence>
        {profileOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="absolute top-16 right-6 w-48 bg-white rounded-xl shadow-lg border"
          >
            <div className="p-2 space-y-1">
              ...
              <button className="w-full text-left px-4 py-2 rounded-lg hover:bg-gray-50 text-red-500">
                Sign Out
              </button>
            </div>
          </motion.div>
